...
contract LPRefund is Initializable, AccessControlUpgradeable {
    ...
    event TaxRefunded(bytes32 indexed txhash, address recipient, uint256 amount);
    ...
    function initialize(address defaultAdmin_, address taxToken_) external initializer {
    ...
    function manualRefund(bytes32 txhash, address recipient, uint256 amount) public onlyRole(ADMIN_ROLE) {
        refunds[txhash] += amount;
