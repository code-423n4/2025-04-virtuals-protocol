...
interface IValidatorRegistry {
    ...
    function isValidator(uint256 virtualId, address account) external view returns (bool);

    function validatorScore(uint256 virtualId, address validator) external view returns (uint256);
    ...
    function validatorAt(uint256 virtualId, uint256 index) external view returns (address);
