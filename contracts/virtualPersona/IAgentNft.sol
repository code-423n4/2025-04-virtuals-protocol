...
interface IAgentNft is IValidatorRegistry {
    ...
    function stakingTokenToVirtualId(address daoToken) external view returns (uint256);
    ...
    function virtualLP(uint256 virtualId) external view returns (VirtualLP memory);

    function totalSupply() external view returns (uint256);

    function totalStaked(uint256 virtualId) external view returns (uint256);

    function getVotes(uint256 virtualId, address validator) external view returns (uint256);
    ...
    function getAllServices(uint256 virtualId) external view returns (uint256[] memory);
