...
abstract contract ValidatorRegistry is IValidatorRegistry, Initializable {
    ...
    function isValidator(uint256 virtualId, address account) public view returns (bool) {
    ...
    function validatorScore(uint256 virtualId, address validator) public view virtual returns (uint256) {
    ...
    function validatorAt(uint256 virtualId, uint256 index) public view returns (address) {
