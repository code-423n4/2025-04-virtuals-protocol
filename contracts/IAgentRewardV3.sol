...
interface IAgentRewardV3 {
    ...
    event StakerRewardClaimed(uint256 indexed virtualId, address indexed staker, uint256 numRewards, uint256 amount);

    event ValidatorRewardClaimed(uint256 indexed virtualId, address indexed validator, uint256 amount);
