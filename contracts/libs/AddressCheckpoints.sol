...
library AddressCheckpoints {
    ...
    function _insert(Checkpoint[] storage self, uint48 key, address value) private {
    ...
    function upperLookupRecent(Trace storage self, uint48 key) internal view returns (address) {
